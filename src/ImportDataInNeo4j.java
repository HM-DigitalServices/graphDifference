...
public class ImportDataInNeo4j {
	...
	private static Map<Integer, String> nodeLabels = new HashMap<Integer, String>();
	...
	public static void main(String[] args) {
		...
		try (Transaction tx = x.beginTx()) {
			...
			boolean[][] adjacency = createAdjacency(x);
	...
	private static boolean[][] createAdjacency(GraphDatabaseService x) {
		...
		boolean[][] adjacency = new boolean[nodes.size()][nodes.size()];
	...
	private static void printAdjacency(boolean[][] adjacency) {
		int fieldWidth = 10;
